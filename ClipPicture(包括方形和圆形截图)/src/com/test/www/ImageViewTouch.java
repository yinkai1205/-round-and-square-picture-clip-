...
public class ImageViewTouch extends ImageView {
	...
	private void setImageBitmap(Bitmap bitmap, int rotation) {
		...
		// }
		Log.d(TAG, "thumbnail setImageBitmap");
		// Log.d(TAG, "thumbnail setImageBitmap: " + errors.toString());
	...
	public void setImageBitmapResetBase(final Bitmap bitmap,
		...
		Log.d(TAG, "setImageBitmapResetBase");
	...
	public void touchEdge(int top, int left, int bottom, int right) {
		if (mBitmapDisplayed.getBitmap() == null) {
			return;
		}
		...
		if (rect.bottom < bottom) {
			deltaY -= (rect.bottom - bottom);
		}

		if (rect.left > left) {
			deltaX -= (rect.left - left);
		}

		if (rect.right < right) {
			deltaX -= (rect.right - right);
		}
